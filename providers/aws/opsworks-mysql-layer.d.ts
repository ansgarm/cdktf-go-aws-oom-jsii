...
export declare class OpsworksMysqlLayer extends cdktf.TerraformResource {
    ...
    get rootPasswordOnAllInstances(): boolean;
    set rootPasswordOnAllInstances(value: boolean);
    resetRootPasswordOnAllInstances(): void;
    get rootPasswordOnAllInstancesInput(): boolean | undefined;
    private _stackId;
    get stackId(): string;
    ...
    resetEbsVolume(): void;
    get ebsVolumeInput(): OpsworksMysqlLayerEbsVolume[] | undefined;
